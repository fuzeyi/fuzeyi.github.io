---
layout: post
title: webstorm - 安装和激活
date:   2017-03-10 23:00:00 +0800
categories: Soft
tag: JetBrains
---
...
+ 2017.2.27版本的破解方式：
{% highlight bash %}
安装以后，打开软件会弹出一个对话框；选择“license server” 输入：http://idea.imsxm.com/
{% endhighlight %}
+ 2016.2.2 版本的破解方式：
{% highlight bash %}
...
+ 2016.2.3 版本的破解方式： 
{% highlight bash %}
安装以后，打开软件会弹出一个对话框，在打开的License Activation窗口中选择“activation code”，在输入框输入下面的注册码:
